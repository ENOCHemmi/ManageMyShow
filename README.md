...
This project implements a terminal-based **ManageMyShow** using **Object-Oriented Programming (OOP)** concepts in C++. The system allows interaction for two user roles: **Manager** and **Customer**, with distinct features and operations for each role.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/your-repo/ManageMyShow.git
   ```
...
3. Compile the code:
   ```bash
   g++ -o manage_my_show ManageMyShow.cpp
   ```
